...
const NavBarMain = () => {
  ...
  return (
    ...
    >
      <div
        className="flex justify-between w-full max-w-[1200px] mx-auto bg-[#1e1917] items-center p-6 rounded-r-full rounded-l-full border-[0.5px] border-orange" /*import all the nav components as show above and return then in the nav container with the class name as shown. put all the nav components (NavLogo, links and buttons wrapped in a div and define their class name as shown here) rounded-r and -l makes the edges fully rounded, p-6 adds an equal padding all round. Give it a thin border of 0.5px and set border to orange to outline the border as shown*/
      >
        <NavBarLogo />
        <div
          className={`${
